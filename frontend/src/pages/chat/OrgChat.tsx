...
const OrgChat: React.FC = () => {

  const { channel_id } = useParams()

  return (
    <>
      <div className="flex-1 flex flex-col bg-purple-300 w-full">
      
        <header className="flex items-center justify-between h-16 px-4 bg-gray-300 border-b border-gray-400">
          <h1 className="text-lg font-semibold">{channel_id}</h1>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="text-center mb-4">
            <h2 className="text-lg font-semibold">Počátek chatu v organizaci {channel_id}</h2>
